...
- 🗃️ [Retenção dos documentos](#retenção-dos-documentos)
- 💵 [Custo de armazenamento](#custo-de-armazenamento)
- ⚖️ [O dilema central](#o-dilema-central)
...
- 🛠️ [Serviços AWS utilizados](#serviços-aws-utilizados)
- 🚶 [Jornada do Cliente](#jornada-do-cliente)
- 🏗️ [Arquitetura AWS](#arquitetura-aws)
- 🛡️ [Resiliência e tolerância a falhas](#resiliência-e-tolerância-a-falhas)
